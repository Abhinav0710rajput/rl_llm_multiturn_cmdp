...
By sweeping $d_1 \in \{0, 1\}$, we compare a ``never ask'' policy against one that may ask at most one question on average. The Lagrangian automatically learns the appropriate penalty $\lambda_1$ to satisfy the budget constraint.
